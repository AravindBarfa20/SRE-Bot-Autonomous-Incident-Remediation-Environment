...
SCENARIOS: Dict[str, ScenarioProfile] = {
    ...
    "MEDIUM": ScenarioProfile(
        difficulty="MEDIUM",
        task_name="connection-pool-exhaustion",
        faulty_target="db-proxy",
        remediation_action=ActionType.SCALE_UP,
        remediation_target="db-proxy",
        initial_system_health=61,
        active_alerts=[],
        node_health_scores={
            "api-gateway": 100,
            "auth-service": 100,
        ...
        metrics={
            "api-gateway": {"cpu": 42.0, "ram": 55.0, "latency": 88.0},
            "auth-service": {"cpu": 28.0, "ram": 44.0, "latency": 32.0},
            "db-proxy": {"cpu": 78.0, "ram": 91.0, "latency": 340.0},
        },
        logs=[
            {
                "message": "connection pool running at 94% capacity",
                "target": "db-proxy",
                "status": "WARN",
                "health": "degraded",
            },
            {
                "message": "waiting threads backlog growing",
                "target": "db-proxy",
                "status": "WARN",
                "health": "degraded",
            },
            {
                "message": "no active alerts - system nominal",
                "target": "api-gateway",
                "status": "INFO",
                "health": "healthy",
            },
            {
                "message": "pool exhausted - new connections being rejected",
                "target": "db-proxy",
                "status": "WARN",
                "health": "degraded",
            },
        ...
        resolved_metrics={
            "api-gateway": {"cpu": 26.0, "ram": 43.0, "latency": 28.0},
            "auth-service": {"cpu": 21.0, "ram": 40.0, "latency": 19.0},
            "db-proxy": {"cpu": 31.0, "ram": 58.0, "latency": 38.0},
        },
        resolved_node_health_scores={
            "api-gateway": 100,
            "auth-service": 100,
